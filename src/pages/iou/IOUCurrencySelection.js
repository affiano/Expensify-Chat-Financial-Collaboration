...
class IOUCurrencySelection extends Component {
    ...
    confirmCurrencySelection(option) {
        ...
        // Note: This hack does not work for the edit case because it will only ever have one route. Some other solution would be required if we
        // want this edge case to work.
        if (_.isEmpty(backTo) || (this.props.navigation.getState().routes.length === 1 && !backTo.includes('edit'))) {
            Navigation.goBack();
        } else {
